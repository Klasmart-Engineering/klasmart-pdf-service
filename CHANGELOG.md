...
### [0.5.11-dev.1](https://bitbucket.org/calmisland/kidsloop-pdf-service/compare/v0.5.11-dev.0...v0.5.11-dev.1) (2022-06-22)

### [0.5.11-dev.0](https://bitbucket.org/calmisland/kidsloop-pdf-service/compare/v0.5.10...v0.5.11-dev.0) (2022-05-12)

### [0.5.10](https://bitbucket.org/calmisland/kidsloop-pdf-service/compare/v0.5.9...v0.5.10) (2022-04-27)
...
### [0.5.9-dev.4](https://bitbucket.org/calmisland/kidsloop-pdf-service/compare/v0.5.9-dev.1...v0.5.9-dev.4) (2022-04-08)
...
* **metadata:** add additional pdf processing steps to store pdf outline, page index metadata, add /metadata pdf endpoint to retrieve data ([fc35ee8](https://bitbucket.org/calmisland/kidsloop-pdf-service/commit/fc35ee879414fc457ef2633a8cc0590be80f5cf1))


### Bug Fixes

* **KLL-3119:** fix issue causing crash, render failures due to unicode null in metadata received from pdf.js ([3481d42](https://bitbucket.org/calmisland/kidsloop-pdf-service/commit/3481d424e17b6c715de0c1c64b1c9e5e04c014f0))
* lock typeorm version to 0.2.34 to prevent unit test failure ([c2e3d69](https://bitbucket.org/calmisland/kidsloop-pdf-service/commit/c2e3d694b309521e11e6d3f6e5b68405d9229cd4))
* move audit fix to after prune to avoid causing issues with babel ([c4850fe](https://bitbucket.org/calmisland/kidsloop-pdf-service/commit/c4850fef10ddff0aea320c6f8fd3301ec1ba1d4c))

## [0.5.8](https://bitbucket.org/calmisland/kidsloop-pdf-service/compare/v0.4.4...v0.5.8) (2022-03-02)
